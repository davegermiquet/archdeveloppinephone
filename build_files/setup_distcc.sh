#!/bin/bash
pacman -Syu --noconfirm xz qemu-arch-extra distcc git rsync base-devel cmake sdl2 glew-wayland glew1.10 libglvnd openssl sqlite3 gtk2 zlib nasm gxmessage kdialog fluidsynth sdl sdl2 glu
